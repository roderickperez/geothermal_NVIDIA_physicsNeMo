...
def run(cfg: PhysicsNeMoConfig) -> None:
    ...
    print("Starting data preprocessing loop 1...")
    # Using trange for progress bar instead of manual print statements
    for kk in trange(X_data1.shape[0], desc="Preprocessing Training Data"):
        # if kk % 10 == 0: print(f"Processing item {kk}/{X_data1.shape[0]}") # Removed manual print
    ...
    print("Saving intermediate MAT file...")
    sio.savemat(
    ...
    print("Preprocessing FNO MAT file...")
    ...
    print("Starting data preprocessing loop 2...")
    # Using trange for progress bar instead of manual print statements
    for kk in trange(X_data2.shape[0], desc="Preprocessing Test Data"):
        # if kk % 10 == 0: print(f"Processing item {kk}/{X_data2.shape[0]}") # Removed manual print
    ...
    print("Saving intermediate MAT file 2...")
    sio.savemat(
    ...
    print("Preprocessing FNO MAT file 2...")
